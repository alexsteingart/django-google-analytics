...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'google_analytics_analytics', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('analytics_code', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal(u'google_analytics', ['Analytics'])


    def backwards(self, orm):
        # Deleting model 'Analytics'
        db.delete_table(u'google_analytics_analytics')


    models = {
        u'google_analytics.analytics': {
